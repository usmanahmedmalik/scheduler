...
export default function LandingPage({ onGetStarted, onLogin, isLoggedIn }) {
    return (
        <div className="flex flex-col min-h-screen bg-white">
            ...
            <main className="flex-grow flex flex-col items-center justify-center text-center px-6">
                <div className="max-w-3xl mx-auto space-y-8">
                    ...
                    <button onClick={onGetStarted} className="px-8 py-4 bg-indigo-600 text-white text-lg font-bold rounded-xl hover:bg-indigo-700 shadow-lg transition-all">
